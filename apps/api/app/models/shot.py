...
class Shot(Base):
    ...
    versions = relationship("ShotVersion", back_populates="shot", cascade="all, delete-orphan", foreign_keys="ShotVersion.shot_id")
    active_version = relationship("ShotVersion", foreign_keys=[active_version_id], post_update=True)
